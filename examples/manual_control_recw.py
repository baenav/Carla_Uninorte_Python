...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        world.x_history.append(t.location.x)
        world.y_history.append(t.location.y)
        world.yaw_history.append(t.rotation.yaw)
        world.speed_history.append(3.6 * math.sqrt(v.x**2 + v.y**2 + v.z**2))
